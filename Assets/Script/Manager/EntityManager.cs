...
public class EntityManager : MonoBehaviour
{
  ...
  public BaseEntity CreateEntity(TypeEntity typeEntity, GridNode node)
  {
    BaseEntity entity = null;
    GameEntity enityConfig = ResourceSystem.Instance.GetAllEntity().Where(t => t.typeEntity == typeEntity).FirstOrDefault();
    if (enityConfig != null)
    {
      entity = new Entity();
      entity.SetConfig(enityConfig);
      entity.SetNode(node);
      entity.CreateEntity().Forget();
    }
