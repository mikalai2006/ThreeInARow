...
public class LevelManager : Singleton<LevelManager>
{
  ...
  public async UniTask InitLevel()
  {
    ...
    foreach (var node in GridHelper.GetAllGridNodes())
    {
      EntityManager.CreateEntity(TypeEntity.Banan, node);
    }
  ...
  {
    GridHelper = new GridHelper(_gameManager.GameSettings.gridWidth, _gameManager.GameSettings.gridHeight);
    Debug.Log($"Create grid {_gameManager.GameSettings.gridWidth}x{_gameManager.GameSettings.gridHeight}");
    // // Set transform grid.
